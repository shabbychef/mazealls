...
Description: Supports the generation of parallelogram, equilateral
    ...
    the domain is divided into subdomains in which mazes are generated,
    then dividing lines with holes are drawn between them, see
    Jamis Buck, Recusive Division, http://weblog.jamisbuck.org/2011/1/12/maze-generation-recursive-division-algorithm .
Depends: 
    R (>= 3.0.2)
Imports:
    TurtleGraphics
