...
```{r para_maze,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
...
```{r para_imbalance_fade,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
...
```{r eq_tri_uniform,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# uniform method
turtle_init(1000,1000)
...
```{r eq_tri_stack,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# stacked trapezoids
turtle_init(1000,1000)
...
```{r eq_tri_four_tri,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# four triangles
turtle_init(1000,1000)
...
```{r eq_tri_two_ears,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# two ears
turtle_init(1000,1000)
...
```{r eq_tri_hex_and_three,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# hex and three
turtle_init(1000,1000)
...
```{r eq_tri_shave,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# shave 
turtle_init(1000,1000)
...
```{r eq_tri_shave_all,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# shave all
turtle_init(1000,1000)
...
```{r hex_trapezoids,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# two trapezoids
turtle_init(1000,1000)
...
```{r hex_triangles,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# six triangles
turtle_init(1000,1000)
...
```{r hex_parallelo,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# six triangles
turtle_init(1000,1000)
...
```{r trap_four,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# four trapezoids
turtle_init(1000,1000)
...
```{r trap_ear,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# one ear
turtle_init(1000,1000)
...
```{r koch_flake,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# koch
turtle_init(1000,1000)
...
```{r unit_len_stack_trap,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
...
```{r boundary_stuff,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# side by side
...
```{r tri_of_hex,cache=TRUE,eval=TRUE,echo=TRUE,fig.keep='last'}
library(TurtleGraphics)
library(mazealls)
# triangle of hexes
turtle_init(2500,2500)
...
tile_bit <- function(unit_len,depth,clockwise=TRUE,draw_boundary=FALSE,boundary_holes=NULL) {
	...
	turtle_col('black')
	if (draw_boundary) { blines <- 1:4 } else { blines = 1 }
