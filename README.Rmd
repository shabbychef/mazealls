...
sierpinski <- function(unit_len,depth,boundary_lines=FALSE,boundary_hole_sides=NULL,color1='black',color2='green') {
	seglen <- 2^depth
	if (depth > 0) {
		for (iter in 1:3) {
			sierpinski(unit_len,depth-1,color1=color1,color2=color2)
...
turtle_do({
	...
	turtle_setangle(0)
	sierpinski(unit_len=19,depth=7,boundary_lines=TRUE,boundary_hole_sides=c(1,3),color1='black',color2='gray60')
})
